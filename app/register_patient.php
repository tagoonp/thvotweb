...
<head>
    ...
    <title>THVOT : Patient Register</title>
                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                ...
                                                <h4 class="text-left mb-1">ลงทะเบียนผู้ป่วย</h4>
                                        ...
                                        <div class="card-body">
                                            <form  action="./controller/auth?stage=signup_vot" method="POST" autocomplete="off"  onsubmit="return auth.chk_register_vot();">
                                                ...
                                                <div class="form-group mb-50">
                                                    <label class="" for="exampleInputPassword1">ประเภทผู้ป่วย : <span class="text-danger">*</span></label>
                                                    <div>
                                                        <select name="txtPatientType" id="txtPatientType" class="form-control">
