...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <h2 class="mb-2">ข้อมูลผู้ใช้งาน</h2>
                <!-- users edit start -->
                            ...
                            <ul class="nav nav-tabs mb-2" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                        <i class="bx bx-user mr-25"></i><span class="d-none d-sm-block">บัฯชีผู้ใช้งาน</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Username" value="dean3004" name="username" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                    ...
                                                    <select class="form-control">
                                                        ...
                                                        if($result_list['status']){
                                                            ...
                                                            foreach($result_list['data'] as $row){
                                                                ?>
                                                                <option value="<?php echo $row['role_id'];?>" <?php  ?>> <?php echo $row['role_th'];?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="txtHcode" id="txtHcode" class="form-control">
                                                        ...
                                                        if($result_list['status']){
                                                            ...
                                                            foreach($result_list['data'] as $row){
                                                                ?>
                                                                <option value="<?php echo $row['hoscode'];?>" <?php  ?>>[<?php echo $row['hoscode'];?>] <?php echo $row['hosname'];?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
