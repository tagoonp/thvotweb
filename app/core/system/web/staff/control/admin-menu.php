<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                ...
                <li class="nav-item"><a href="#"><i class="bx bxs-videos"></i><span class="menu-title text-truncate" data-i18n="Content">ระบบติดตาม</span></a>
                    <ul class="menu-content">
                        <li class="<?php if($menu == 8){ echo "active"; } ?>"><a class="d-flex align-items-center" href="app-video-patient"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Typography">รายการส่งวีดีโอรอตรวจ</span></a></li>
                ...
                <li class="nav-item <?php if($menu == 81){ echo "active"; } ?>"><a href="./documentation?role=<?php echo $_SESSION['thvot_role'];?>" target="_blank"><i class="menu-livicon" data-icon="notebook"></i><span class="menu-title text-truncate" data-i18n="Documentation">คู่มือการใช้งาน</span></a></li>
                <li class="nav-item <?php if($menu == 82){ echo "active"; } ?>"><a href="./question"><i class="menu-livicon" data-icon="question-alt"></i><span class="menu-title text-truncate" data-i18n="Raise Support">คำถามที่พบบ่อย</span></a></li>
                <li class="nav-item <?php if($menu == 83){ echo "active"; } ?>"><a href="./contact"><i class="menu-livicon" data-icon="help"></i><span class="menu-title text-truncate" data-i18n="Raise Support">ติดต่อฝ่ายสนับสนุน</span></a></li>
            </ul>