                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="users-list-datatable-" class="table">
                                        ...
                                        <tbody>
                                            <?php 
                                            $strSQL = "SELECT * FROM vot2_phamalist WHERE 1";
                                            ...
                                            if($result_list['status']){
                                                ...
                                                foreach($result_list['data'] as $row){
                                                    ...
                                                    <tr>
                                                        <td><?php echo $c; ?></td>
                                                        <td><?php echo $row['phama_name']; ?></td>
                                                        <td class="text-right">
                                                            <?php 
                                                            if($_SESSION['thvot_role'] == 'administator'){
                                                                ?>
                                                                
                                                                <a href="Javascript:update_drug('<?php echo $row['phama_id'];?>', '<?php echo $row['phama_name'];?>')" class="mr-1"><i class="bx bx-edit-alt"></i></a>
                                                                <a href="Javascript:delete_drug('<?php echo $row['phama_id'];?>')" clsas=""><i class="bx bx-trash-alt text-danger"></i></a>
                                                                <?php
                                                            }else{
                                                                ?>
                                                                <a href="Javascript:update_drug('<?php echo $row['phama_id'];?>', '<?php echo $row['phama_name'];?>')" class="mr-1"><i class="bx bx-edit-alt"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">แก้ไขชื่อยา</h5>
                ...
                <form action="../../../controller/facility?stage=update_project_hosital" method="post" onsubmit="return facility.check_admin_update_hosp()">
                    <div class="modal-body">
                        <div class="form-group" style="display: none;">
                            ...
                            <input type="text" class="form-control" readonly placeholder="" id="txtDrugId" name="txtDrugId">
                        </div>
                        <div class="form-group">
                            <label for="">ชื่อยา</label>
                            <input type="text" class="form-control" placeholder="" id="txtDrugName" name="txtDrugName">
                        </div>
                    </div>
