...
<head>
    ...
    <title>NCDx : Reset รหัสผ่าน</title>
                                    ...
                                    <div class="card disable-rounded-right d-flex justify-content-center mb-0 p-2 h-100">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="text-center mb-2">รีเซ</h4>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <form class="mb-2" action="./controller/auth?stage=signup"  autocomplete="off" class="login-frm" onsubmit="return auth.chk_register();">
