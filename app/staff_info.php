...
$strSQL = "SELECT * FROM vot2_account WHERE uid = '$uid' AND delete_status = '0'";
                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100">
                                        ...
                                        <div class="card-body">
                                            <h3 class="text-center mb-1">THVOT</h3>
                                                <h4 class="text-center mb-1">ลงทะเบียนเจ้าหน้าที่</h4>
                                            <div class="text-center pt-3">
                                            บัญชีผู้ใช้ของท่านได้ลงทะเบียนเรียบร้อยแล้ว กรุณาเข้าสู่ระบบจากหน้า Log in หลังจากท่านได้รับการอนุมัติใช้ใช้งานแล้ว<br>หากไม่ได้รับการอนุมัติการเข้าใช้งานใน 2 วัน กรุณาติดต่อผู้ดูแล
                                            </div>
                                        </div>
                                    </div>
                                </div>
