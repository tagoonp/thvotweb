        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                ...
                <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="heart"></i><span class="menu-title text-truncate" data-i18n="User">สถานบริการ</span></a>
                    <ul class="menu-content">
                        <li class="active"><a class="d-flex align-items-center" href="app-facility-list"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">รายชื่อเปิดใช้งาน</span></a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="users-list-datatable" class="table">
                                        ...
                                        <tbody>
                                            <?php 
                                            $strSQL = "SELECT a.*, x.hosname reshname , c.*, b.*, b.Name CWNAME FROM vot2_chospital a INNER JOIN vot2_changwat b ON a.provcode = b.Changwat
                                            LEFT JOIN vot2_projecthospital c ON a.hoscode = c.phoscode
                                            LEFT JOIN vot2_chospital x ON a.hoscode = x.hoscode
                                            WHERE 
                                            c.phosstatus = 'Y'";
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="txtMainhname" id="txtMainhname" class="select2 form-control">
                                            ...
                                            <?php 
                                            $strSQL = "SELECT * FROM vot2_projecthospital WHERE htype_code != 'HPH' ORDER BY hserv";
                                            $result_h = $db->fetch($strSQL, true);
                                            if($result_h['status']){
                                                foreach($result_h['data'] as $row){
                                                    ?>
                                                    <option value="<?php echo $row['phoscode'];?>"><?php echo $row['hserv'];?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
