...
<head>
    ...
    <title>NCDx : Administator -> สถานบริการ</title>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
                ...
                <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="heart"></i><span class="menu-title text-truncate" data-i18n="Facility">สถานบริการ</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="active"><a class="d-flex align-items-center" href="app-facility-add"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="View">เพิ่มสถานบริการใหม่</span></a></li>
                    </ul>
                </li>
